...
public abstract class NineGridAbstractLayout extends ViewGroup {
    ...
    public NineGridAbstractLayout(Context context) {
        super(context);
        init(context);
    }

    public NineGridAbstractLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NineGridAbstractLayout);

        mSpacing = typedArray.getDimension(R.styleable.NineGridAbstractLayout_sapcing, DEFUALT_SPACING);
        widthScale = typedArray.getFloat(R.styleable.NineGridAbstractLayout_widthscale,0f);
        typedArray.recycle();
        init(context);
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if(widthScale != 0f) {
            mTotalWidth = (int) (mTotalWidth * widthScale);
        }
